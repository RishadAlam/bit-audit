 ...
 * Description:        Audits the Bit ecosystem. Pick a plugin (Bit Integrations or Bit Flows), combine its Free + Pro, and report total/platform integrations, triggers and actions, and per-event detail with Free/Pro/Both tiers.
 * Version:           1.0.0
 * Author:            Bit Apps
...
define( 'BIT_AUDIT_VERSION', '1.0.0' );
